                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="disburesed_loan.php">
                                                <h5><b>AMONGIN CHRISTINE - Long Term Loan</b></h5>
                                            </a>
                                            <p class="p-0"> Trading/Business</p>
                                            <p class="p-0">00002450</p>                                            
                                        </div>
                                        <div class="col-6">
                                            <h5 class="text-right"><b><span class="text-success">UGX</span> 3,000,000</b></h5>
                                            <p class="text-right">Applied May 12, 2023</p>
                                            <p class="text-right">Appraised May 8, 2023</p>                                           
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                            <a href="disburesed_loan.php">
                                                <h5><b>LWAYA JOSEPH - Long Term Loan</b></h5>
                                            </a>
                                    ...
                                    <div class="col-6">
                                            <a href="disburesed_loan.php">
                                                <h5><b>KAMUKA EDWARD - Micro Business Loan</b></h5>
                                            </a>
                                            <p class="p-0">Education</p>
                                            <p class="p-0">00002450</p>                                            
                                        </div>
