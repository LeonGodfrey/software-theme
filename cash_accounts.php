                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div role="group" class="btn-group">
                                    <ul class="nav">
                                        <li>
                                            <a href="cash_accounts.php" class="btn btn-info">Cash Accounts</a>
                                        </li>
                                        <li>
                                            <a href="vault_accounts.php" class="btn btn-default btn-info">Vault Accounts</a>
                                        </li>
                                        <li>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="cash_account.php">
                                                <h4><b>Nebbi-Branch - Cashier</b></h4>
                                            </a>
                                            <p class="p-0">Cashier</p>
                                        </div>
                                        <div class="col-6">                                            
                                            <p class="text-right text-success">Current Balance</p>
                                            <h5 class="text-right"><b><span class="text-success">UGX</span> 2,672,650</b></h5>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                            <a href="cash_account.php">
                                                <h4><b>Arua-Branch - Cashier</b></h4>
                                            </a>
                                            <p class="p-0">Cashier</p>
                                        </div>
                                        <div class="col-6">                                            
                                            <p class="text-right text-success">Current Balance</p>
                                            <h5 class="text-right"><b><span class="text-success">UGX</span> 1,761,950</b></h5>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider"></div>
                                    <div class="row">
                                    <div class="col-6">
                                            <a href="cash_account.php">
                                                <h4><b>Koboko-Branch - Cashier</b></h4>
                                            </a>
                                            <p class="p-0">Cashier</p>
                                        </div>
                                        <div class="col-6">                                            
                                            <p class="text-right text-success">Current Balance</p>
                                            <h5 class="text-right"><b><span class="text-success">UGX</span> 1,417,300</b></h5>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
