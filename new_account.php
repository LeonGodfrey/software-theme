                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label style="font-weight: normal;" for="amount">Account Name *</label>
                                                    <input name="amount" type="text" class="form-control" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label style="font-weight: normal;" for="Select Branch">Account Type*</label>
                                                    <select class="select2" style="width: 100%;">
                                                        <option selected>Assets</option>
                                                        <option>Equity</option>
                                                        <option>Expense</option>
                                                        <option>Laibility</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
